...
def translate_to_bengali(text):
    try:
        ...
        post_fixes = {
            ...
            "কোলেবি কলেজ": "কলকাতা বিশ্ববিদ্যালয়",
            "কোলকাবি": "কলকাতা বিশ্ববিদ্যালয়",
            "কোকিল বিশ্ববিদ্যালয়": "কলকাতা বিশ্ববিদ্যালয়",
            "এম এ দ্য কোলকাবি": "কলকাতা বিশ্ববিদ্যালয়",
            "কলকাতা কলেজ": "কলকাতা বিশ্ববিদ্যালয়",
            "কলকাতার বিশ্ববিদ্যালয়": "কলকাতা বিশ্ববিদ্যালয়",
            "কোলকাতা বিশ্ববিদ্যালয়": "কলকাতা বিশ্ববিদ্যালয়",
            "কোলকানি": "কলকাতা",
            "কলেজ (সিইউ)": "কলকাতা বিশ্ববিদ্যালয় (সিইউ)",
            "কলেজের ফি": "কলকাতা বিশ্ববিদ্যালয়ের ফি",
            "কলেজের তুলনায়": "কলকাতা বিশ্ববিদ্যালয়ের তুলনায়",
            "কোলকানি এবং কল্যাণী": "কলকাতা এবং কল্যাণী",
            "কল্যাণী কলেজ": "কল্যাণী বিশ্ববিদ্যালয়",
            "কল্যাণের বিশ্ববিদ্যালয়": "কল্যাণী বিশ্ববিদ্যালয়",
            "কলানি বিশ্ববিদ্যালয়": "কল্যাণী বিশ্ববিদ্যালয়",
            "কল্যানী বিশ্ববিদ্যালয়": "কল্যাণী বিশ্ববিদ্যালয়",
            "কল্যানী": "কল্যাণী",
            "কলানি": "কল্যাণী",
            "যাদবপুর কলেজ": "যাদবপুর বিশ্ববিদ্যালয়",
            "জাদবপুর বিশ্ববিদ্যালয়": "যাদবপুর বিশ্ববিদ্যালয়",
            "জাবি": "যাদবপুর বিশ্ববিদ্যালয়",
            "যদবপুর": "যাদবপুর",
            "যাও যাদবপুর": "যাদবপুর",
            "জানাবপুর": "যাদবপুর",
            "যাদবপুর টেক এম টেক": "যাদবপুর বিশ্ববিদ্যালয়ে এম.টেক",
            "সমাবেশ": "বিশ্ববিদ্যালয়ের",
            "দুই দলের": "উভয় বিশ্ববিদ্যালয়ের",
            "দল": "বিশ্ববিদ্যালয়",
            "কেউ কেউ-এর": "কল্যাণী বিশ্ববিদ্যালয়ের",
            "কোলকাবিরটি": "কলকাতা বিশ্ববিদ্যালয়ের",
            # ── COURSE NAME FIXES ──
            ...
            "মাস্টার অফ লস": "এলএলএম",
            "মাস্টার অফ আর্টস": "এম.এ",
            "মাস্টার অফ সায়েন্স": "এম.এস.সি",
            "ব্যাচেলর অফ আর্টস": "বি.এ",
            "ব্যাচেলর অফ সায়েন্স": "বি.এস.সি",
            "ব্যাচেলর অফ এডুকেশন": "বি.এড",
            "মাস্টার অফ এডুকেশন": "এম.এড",
            "ব্যাচেলর অফ ফার্মেসি": "বি.ফার্ম",
            "মাস্টার অফ ফার্মেসি": "এম.ফার্ম",
            "প্রধান অফ লস": "মাস্টার অফ লজ (এলএলএম)",
            "এল এম এল এম": "এলএলএম",
            "বিএলএলবি": "বি.এ.এলএলবি",
            "কর্তৃপক্ষ এলবি": "এলএলবি",
            "এম.টি.": "এম.টেক.",
            "বি.বি.": "বি.এস.সি.",
            "বি. কমিশন।": "বি.এস.সি.",
            "বি.এসিসিস।": "বি.এস.সি.",
            "বি.এসিসিস.": "বি.এস.সি.",
            # ── SUBJECT/DEPARTMENT FIXES ──
            ...
            "গণিত বিজ্ঞান": "গণিত",
            "সাইয়েন্স": "সায়েন্স",
            "কম্পিউটার বিজ্ঞ": "কম্পিউটার বিজ্ঞান",
            "সাইনস": "সায়েন্স",
            "নির্বাচনিং": "ইঞ্জিনিয়ারিং",
            "প্রযুক্তিিং": "ইঞ্জিনিয়ারিং",
            "অ্যান্ড্রয়েডিং": "ইঞ্জিনিয়ারিং",
            "ইলেকট্রিকালিং": "ইলেকট্রিক্যাল",
            "কেমিক্যালিং": "কেমিক্যাল",
            "খেলাধুলায়": "ইঞ্জিনিয়ারিংয়ে",
            "পাওয়ারিং": "পাওয়ার",
            "আলোকসজ্জায়": "অপটিক্যালে",
            "অটোমোবাইলিং": "অটোমোবাইল ইঞ্জিনিয়ারিং",
            "কালিং কোর্সের": "কোর্সের",
            "মাইক্রোওয়েভ এবং মহাকাশ বিজ্ঞান": "মাইক্রোওয়েভ ইঞ্জিনিয়ারিং",
            "কৃত্রিম বুদ্ধিমত্তা": "আর্টিফিশিয়াল ইন্টেলিজেন্স",
            "বাতুল্য": "বা সমতুল্য",
            "বৈধ ০ স্কোর": "বৈধ গেট স্কোর",
            "লাইফলংগ": "লাইফলং",
            # ── COMMON WRONG WORDS ──
            "আমেরিকা": "তথ্য",
            "মার্কিন যুক্তরাষ্ট্র": "মার্কশিট",
            "পিডিএফ প্রসঙ্গ": "আপনার মার্কশিট অনুযায়ী",
            "চরিত্রহক": "তবে",
            "বৈশিষ্ট্যহোক": "তবে",
            "বিবেচনাভাবে": "স্পষ্টভাবে",
            "ম্যানেমেটেড": "ম্যানেজমেন্ট",
            "ব্যবসায়িক ম্যানেমেটেডের": "কলকাতা বিশ্ববিদ্যালয়ের এমবিএর",
            "স্নাক": "স্নাতক",
            "স্নাক (অনার্স)": "স্নাতক (অনার্স)",
            "ব্যাচের": "স্নাতক",
            "গ্রেডেপয়েন্ট নীতি": "গ্রেড পয়েন্ট অনুযায়ী",
            "সামনের জন্য": "নিম্নলিখিত কোর্সগুলির জন্য",
            "নেতার জন্য": "কোর্সের জন্য",
            "সূত্রের বিবরণ": "কোর্সের বিবরণ",
            "প্রেসক্রিপশন অফিস ফর্মটি": "কোনো নির্দিষ্ট কোর্সে",
            "পরীক্ষায় ওয়েবসাইট": "বিশ্ববিদ্যালয়ের ওয়েবসাইট",
            "৩টি প্রকাশনা": "৩ বছরের",
            "৫টি সিরিজ": "৫ বছরের",
            "সাত্কার": "সাক্ষাৎকার",
            "ফেসবুক ফি": "কোর্স ফি",
            "জিট": "সহ",
            "প্রোটিন": "অগ্রসর",
            "আলোচনা করেছেন": "পড়েছেন",
            "পরিচয় দিতে": "আবেদন করতে",
            "জ্ঞাত সিদ্ধান্ত": "সঠিক সিদ্ধান্ত",
            "ফ্যাকাল্টি": "শিক্ষক",
            "ডাটাবেস": "ডেটাবেস",
            "স্বাগতিক": "উপযুক্ত",
            "পরিবেশের": "কোর্সের",
            "ধারণার": "কোর্সের",
            "পরিবর্তন আমারিট বন্ধু": "ভর্তি মেধা ভিত্তিক",
            "বৈঠকের": "সাক্ষাৎকারের",
            "প্রকাশের": "প্রোগ্রামের",
            "চিন্তার": "প্রোগ্রামের",
            "সুবিধা হল": "যোগ্যতা হল",
            "বিবেচনার": "কোর্সের",
            "বিবেচনা করছে": "অফার করছে",
            "নির্বাচন করতে": "",
            "গুলিকে": "",
            ...
            # Additional fixes
            "বিজ্ঞানান": "বিজ্ঞান",
            "কম্পিউটারিং": "ইঞ্জিনিয়ারিং",
            "যাবপুর": "যাদবপুর",
            "কমিটি অফিস": "ভর্তি অফিস",
            "সমষ্টি": "মোট",
            "প্রাসঙ্গিক বলে বিবেচিত হতে পারে": "প্রাসঙ্গিক",
            "বিশদভাবে": "বিস্তারিতভাবে",
            "অপরিহার্য": "জরুরি",
        }
...
# ─── COURSE ALIASES ─────────────────────────────────────────────────────────
course_alias = {
    "ba": ["ba", "b.a", "bachelor of arts","B.A.","B.A"],
    "bsc": ["bsc", "b.sc", "bachelor of science","B.Sc.","B.Sc"],
    "bcom": ["bcom", "b.com", "bachelor of commerce","B.COM.","B.Com","B.Com."],
    "btech": ["btech", "b.tech", "b tech","B.TECH.","B.Tech.","B.Tech"],
    "be": ["be", "b.e","B.E.","BE","B.E"],
    "bca": ["bca","BCA","bachelor of computer application"],
    "bba": ["bba","BBA","B.B.A","B.B.A."],
    "bed": ["bed", "b.ed", "B.Ed.","bachelor of education", "b.ed.","B.Ed"],
    "bpharm": ["bpharm", "b.pharm","B.Pharm","B.PHARM","B.Pharm."],
    "barch": ["barch","B.Arch","b.arch","B.Arch.","b.arch."],
    "llb": ["llb","LLB"],
    "dhhm": ["dhhm","DHHM"],
    "dlitt": ["dlitt","D.LITT.","D.Litt.","D.Litt"],
    "ma": ["ma", "m.a","M.A.","M.A"],
    "msc": ["msc", "m.sc","M.Sc.","M.SC","MSc","M.Sc"],
    "mcom": ["mcom", "m.com","M.COM.","MCOM","M.COM","M.Com"],
    "mtech": ["mtech", "m.tech","M.Tech.","M.TECH","M.Tech"],
    "me": ["me", "m.e","M.E.","M.E","ME"],
    "mba": ["mba","MBA","M.B.A.","M.B.A"],
    "mca": ["mca", "master of computer application","MCA"],
    "med": ["med", "m.ed","M.Ed.","M.Ed","master of education","m.ed."],
    "mpharm": ["mpharm", "m.pharm","M.Pharm","M.Pharm."],
    "mhrom": ["mhrom","M.H.R.O.M.","M.H.R.O.M"],
    "march" : ["MARCH","M.Arch.","M.Arch","m.arch"],
    "llm": ["llm","LLM","LL.M.","L.L.M.","LL.M"],
    "mphil": ["mphil", "m.phil","M.Phil","M.PHIL","M.Phil."],
    "mbbs": ["mbbs", "medical","MBBS","M.B.B.S.","M.B.B.S"],
    "phd": ["phd", "ph.d","Ph.D.","PHD","Ph.D"],
    ...
    "bped": ["B.P.Ed","b.p.ed","bachelor of physical education","Bachelor of Physical Education"],
    "idc/mdc": ["IDC/MDC","INSTRUMENTATION SCIENCE","instrumentation science"]
}
